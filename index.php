...
<div class="wrapper row0">
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      ...
      <li><i class="fa fa-phone"></i> 7091175683</li>
        <li><i class="fa fa-phone"></i> 8299126138</li>
        <li><i class="fa fa-phone"></i> 8009411325</li>


        <li><i class="fa fa-envelope-o"></i> 201b190@juetguna.in</li>
        <li><i class="fa fa-envelope-o"></i> 201b237@juetguna.in</li>
        <li><i class="fa fa-envelope-o"></i> 201b258@juetguna.in</li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">MAJOR II GS4</a></h1>
      <h2><a href="index.html">PRASHANT PATEL</a></h2>
      <h2><a href="index.html">SANDALI GUPTA</a></h2>
      <h2><a href="index.html">SHREY PANDEY</a></h2>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/background1.jpg');">
  <section id="testimonials" class="hoc container clear"> 
    <!-- ################################################################################################ -->
    <h2 class="font-x3 uppercase btmspace-80 underlined"> Online <a href="#">Voting System</a></h2>
